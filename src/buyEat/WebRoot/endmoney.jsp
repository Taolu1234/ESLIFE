		...
		<div id="centent" style="width: 760px; position: relative;">
			...
			<div style="width: 600px; height: 200px; float: right;">
				<div style="height: 20px; background-color: #AAB9BD">
					请确认配送和支付信息</div>
				<form action="/buyEat/foodinfoservlet?op=reg" method="post"
					style="border: 1px solid red;">
					<table>
						<tr>
							<td style="text-align: right;">订餐人：</td>
						...
						<tr>
							...
							<td><input type="text" name="movePhone" /></td>
						</tr>
						
						<tr>
							<td style="text-align: right;">配送方式：</td>
							<td><input type="text" value="送餐上门"
								style="margin-left: 10px; margin-right: 20px; width: 100px;" /><input
								style="width: 100px;" type="text" value="10元起送" /></td>
						</tr>
						<tr>
							<td style="text-align: right;">支付方式：</td>
							<td><input type="text" value="餐到付款"
								style="margin-left: 10px; margin-right: 20px; width: 100px;" /><input
								style="width: 100px;" type="text" value="仅限广商校园内" /></td>
						</tr>
						<tr>
							<td style="text-align: right;">订单附言：</td>
							<td><textarea rows="5" cols="37"></textarea></td>
						</tr>
