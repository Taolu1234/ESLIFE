...
<body style="width: 760px; height: 700px; text-align: center;">
    ...
    %>
	<div style="width: 760px; height: 600px;"center">
		...
		<div id="centent" style="width: 760px; position: relative;">
			...
			<div style="width: 600px; height: 200px; float: right;">
				<div style="height: 30px; background-color: #AAB9BD">
					<a href="/buyEat/showcart.jsp"
						Style="display: block; width: 90px; height: 30px; float: right;">
						<img src="images/lcart_cn.gif" style="border: none;" />
					</a>
				</div>
				<%-- 食物信息 --%>
				<div>
					<ul id="fooder" style="margin-left: 10px;">
						<c:forEach var="food" items="${requestScope.foodlist}">
							<li>
								<div class="imagecss">
									<img src="images/${food.foodImage }" width="90" height="110" /><br />
									<br /> 编号：${food.foodID }
								</div>
								<div class="info">
									<span style="font-weight: bold;">${food.foodName }</span><br />
									<span style="color: red; font-size: 12px;">现价：人民币${food.foodPrice }元</span><br />
									<span style="font-size: 12px;"> ${food.description } </span><br />
									<br />
									<br /> <a
										href="/buyEat/foodinfoservlet?op=details&foodid=${food.foodID }"
										style="position: absolute; bottom: 10px;"> <img
										style="border: none;" src="images/detail_cn.gif" /></a>
								</div>
							</li>
						</c:forEach>
					</ul>
