<%@ page language="java" import="java.util.*,com.sxdx.vo.*"
		...
		<div id="centent" style="width: 760px; position: relative;">
			...
			<div style="width: 600px; height: 200px; float: right;">
				<div style="height: 30px; background-color: #AAB9BD">
					<a href=""
						Style="display: block; width: 90px; height: 30px; float: right;"><img
						src="images/lcart_cn.gif" style="border: none;" /></a>
				</div>

				<div>
					<table>
						<tr style="background-color: #b6aeae;">
							<th>商品编号</th>
							<th>商品名称</th>
							<th>商品单价</th>
							<th>商品数量</th>
		   		...
		   		%>
					...
					<div
						style="border: 1px solid green; padding-top: 20px; width: 200px; height: 50px;">
						...
						<input type="button" value="结账" style="margin-left: 20px;"
							onclick="endmoney()" />
						<script type="text/javascript">
						   function endmoney()
						   {
